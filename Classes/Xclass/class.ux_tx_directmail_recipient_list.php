...
if (version_compare(TYPO3_version, '6.2.0', '>=')) {
	class tx_directmail_recipient_list extends \DirectMailTeam\DirectMail\Mod3\tx_directmail_recipient_list {}
}
					...
					case 5:
						...
						if (Tx_DirectMailUserfunc_Utility_ItemsProcFunc::isMethodValid($itemsProcFunc)) {
							...
							if (!isset($extConf['makeEntriesUnique']) || $extConf['makeEntriesUnique'] == 1) {
								...
								if (version_compare(TYPO3_version, '6.2.0', '>=')) {
									$id_lists['PLAINLIST'] = \DirectMailTeam\DirectMail\DirectMailUtility::cleanPlainList($id_lists['PLAINLIST']);
								} else {
