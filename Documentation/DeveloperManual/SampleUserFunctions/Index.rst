...
Finally, user function :php:`user_testList_tca->myRecipientList` shows how you may create enhanced wizard with a
TCA definition instead of a JavaScript-based wizard.
