...
.. code-block:: bash
	...
	rm -rf direct_mail_userfunc
	git clone https://git.typo3.org/TYPO3CMS/Extensions/direct_mail_userfunc.git
	cd direct_mail_userfunc
...
.. code-block:: bash
	...
	cd /path/to/site/typo3conf/ext/direct_mail_userfunc
